...
APP_ONLY_KEYS = {
    'apps/api/config/local/app.env': {
        ...
        'DEV_QUICK_LOGIN_ALLOWED_IPS', 'DEV_QUICK_LOGIN_ENABLED',
...
MAIL_ONLY_KEYS = {
    'apps/api/config/local/app.env': {
        'MAIL_WORKER_POLL_SECONDS', 'MAIL_WORKER_RECOVERY_SECONDS',
        'MAIL_WORKER_STALE_SECONDS', 'MAIL_WORKER_SYSTEMD_SERVICE',
        'ORACLE_MAIL_WORKER_POOL_SIZE',
    },
    'apps/api/config/production/app.env': {
        'MAIL_WORKER_POLL_SECONDS', 'MAIL_WORKER_RECOVERY_SECONDS',
        'MAIL_WORKER_STALE_SECONDS', 'MAIL_WORKER_SYSTEMD_SERVICE',
    ...
    'apps/api/config/local/services.env': {
        ...
        'MAIL_PUBLIC_URL', 'MAIL_UNSUBSCRIBE_SECRET',
        'SMTP_HOST', 'SMTP_PASSWORD', 'SMTP_PORT', 'SMTP_SECURITY', 'SMTP_USERNAME',
    },
